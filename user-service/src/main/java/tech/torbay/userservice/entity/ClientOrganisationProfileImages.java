...
@Entity
@Table(name = "client_organisation_profile_images")
public class ClientOrganisationProfileImages {

    public ClientOrganisationProfileImages() {
	...
	public String toString() {
		return "VendorOrganisationProfileImages [id=" + id + ", clientOrganisationId=" + clientOrganisationId
