...
public interface NotificationRepository extends JpaRepository<Notification, Integer> {
    ...
    @Query(value =" select nt.* from notification nt" + 
    		" inner join " + 
    		" vendor_project_interests vpi on " + 
...
//    		" where ( " +
    ...
    @Query(value =" select nt.* from notification nt" + 
    		" inner join " + 
    		" project_reviews_ratings prr on " + 
    ...
    @Query(value ="select nt.* from notification nt " + 
    		...
    		"projects pro " + 
    		"on ( pro.project_id = bd.project_id ) " + 
    		"inner join project_awards pa on pa.project_id = pro.project_id " + 
    		"where ( " + 
...
//    @Query(value ="select nt.* from notification nt " + 
//    		"INNER JOIN project_reviews_ratings prr " + 
