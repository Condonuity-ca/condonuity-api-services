...
@Entity
@Table(name = "vendor_registration_files")
public class VendorRegistrationFiles {

    public VendorRegistrationFiles() {
	...
	public String toString() {
		return "VendorRegistrationFiles [id=" + id + ", vendorUserId=" + vendorUserId + ", vendorOrganisationId="
				+ vendorOrganisationId + ", containerName=" + containerName + ", blobName=" + blobName + ", fileName="
